...
Validation: `PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 /home/agent/.local/uv/envs/uvpy3.13.2/bin/python -m pytest -q tests/test_core_metrics_single_run.py tests/test_rebuild_core_report.py` passed with 17 tests. A compile check on the touched Python files also passed.
